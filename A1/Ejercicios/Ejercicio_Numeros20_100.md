...
4. **Ordinales**  
   - Completa las frases:  
     1. `Mijn verjaardag is op de ______ (21e)`.  
     2. `De derde oefening is moeilijker dan de ______ (4e)`.  
     3. `Wij wonen op de ______ verdieping (7e)`.

5. **Aplicacion**  
   - Diseña un calendario semanal y anota tres citas usando `t/m`, `jl.`, `a.s.` y ordinales.  
   - Ejemplo: `De les is van maandag t/m donderdag. Het examen is op de vijftiende a.s.`
