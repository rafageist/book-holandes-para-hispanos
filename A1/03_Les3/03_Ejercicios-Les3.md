...
## 1. Conjugacion diaria

1. Elige 5 verbos regulares (`lopen`, `werken`, `drinken`, `maken`, `worden`).  
2. Completa la tabla (pronombre + forma).  
3. Escribe 2 oraciones por verbo usando diferentes sujetos (`Ik drink water`, `Jullie drinken thee`).  
4. Convierte una oracion en pregunta (`Drink jij water?`) e invierte sujeto/verbo.

## 2. Mini parrafo con `worden/denken/nadenken`
...
1. Disena tu menu diario (desayuno, almuerzo, cena).  
2. Indica que adjetivos usarias (`lekker`, `vers`, `zout`, `pikant`).  
3. Describe el menu por escrito y luego leelo en voz alta frente a un espejo.

## 7. Intensificadores (`heel/erg/veel`)

1. Completa: `Het weer is ___ koud`, `Ik heb ___ werk`, `De film was ___ leuk`.  
2. Reescribe las frases cambiando el intensificador para ver el matiz.  
3. Anade una frase en espanol explicando la diferencia.

## 8. Lectura "Zwart Wit"

1. Copia cuatro versos y marca consonantes finales (`-t`, `-d`).  
2. Subraya vocabulario clave y traducelo.  
3. Explica en espanol el mensaje que percibes y redacta dos frases en neerlandes relacionadas con igualdad o libertad.

## 9. Cultura Oranje-Nassau

1. Resume quienes son los Oranje-Nassau, que color los representa y que fiesta nacional los celebra.  
2. Describe los colores de la bandera actual y cuando se anade la banda naranja.  
3. Escribe una frase sobre el himno "Wilhelmus" indicando como muestra lealtad al pais.
