...
1. Cubre la columna de neerlandes y escribe 8 palabras solo viendo la traduccion al español.
...
B: Goed, dank je. Ik oefen de vocalen.
A: Welke woorden zijn moeilijk?
B: Bos, baas en boos. Kun je met me meelezen?
A: Ja, graag. Ik schrijf het op.
```

Variante con colores o frutas (`Ik koop rode appels`, `Hij drinkt een gele smoothie`).

## Checklist semanal

- [ ] Repeti y registre 3 pares minimos.
- [ ] Escribi dos dictados (NL->ES y ES->NL).
