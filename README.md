# Holandés para Hispanohablantes — Vault de curso A1
...
Proveer material didáctico modular y reutilizable para aprender holandés desde cero. El repositorio está pensado para trabajar con Obsidian; el contenido está preparado para ser usado sin dependencias a archivos multimedia externos.

Cómo usar

1. Clona este repositorio en tu equipo.
2. Abre la carpeta con Obsidian o con tu editor de Markdown preferido.
3. Los materiales finales (texto y recursos incluidos en `A1/`) son suficientes para publicar el curso como un libro o PDF.
...
Este proyecto se publica bajo Creative Commons Attribution 4.0 International (CC BY 4.0). Ver `LICENSE`.
